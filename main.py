...
# Baixando os recursos necessários do NLTK para português (execute apenas na primeira vez)

nltk.download('punkt')

nltk.download('stopwords')

nltk.download('rslp') # Baixa o stemmer para o português
...
def preprocess_text_en(text):
    ...
    - Stemming: Reduz as palavras ao seu radical.
    - Converte para minúsculas e remove caracteres não alfabéticos.
    """
    # Tokenização simples usando regex (compatível com português)
    import re
